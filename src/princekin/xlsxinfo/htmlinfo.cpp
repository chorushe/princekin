...
void HtmlInfo::setSaveDir(const QString &arg_saveDir,const QString &arg_jssaveDir)
{
    qHtmlSaveDir=arg_saveDir;
    qJsSaveDir=arg_jssaveDir;
}

void HtmlInfo::setWarningValue(const QString &arg_warning1, const QString &arg_warning2, const QString &arg_warning3, const QString &arg_warning4, const QString &arg_warning5, const QString &arg_warning6)
{
...
void HtmlInfo::setTime_vector(QVector<QString> arg_1,QVector<QString> arg_2,QVector<QString> arg_3,QVector<QString> arg_4,QVector<QString> arg_5,QVector<QString> arg_6)
{
...
void HtmlInfo::setValue_vector(QVector<double> arg_1,QVector<double> arg_2,QVector<double> arg_3,QVector<double> arg_4,QVector<double> arg_5,QVector<double> arg_6)
{
...
void HtmlInfo::createHtml2(QStringList templist)
{
    ...
    QFile file2(gConfigDir + QDir::separator() + "normal_web1.html");
